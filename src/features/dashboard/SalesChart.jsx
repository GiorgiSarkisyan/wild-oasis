  ...
  const data = allDates.map((date) => {
    return {
      ...
      totalSales: bookings
        ...
        .reduce((acc, cur) => acc + (cur.totalPrice || 0), 0), // Safeguard in case totalPrice is undefined
      extrasSales: bookings
        .filter((booking) => isSameDay(date, new Date(booking.created_at)))
        .reduce((acc, cur) => acc + (cur.extrasPrice || 0), 0), // Safeguard in case extrasPrice is undefined
    };
  });
